...
//     try {
//         const token = localStorage.getItem('userToken'); // veya kullandığın token key'i
...
//             // Proje listesini ve arayüzü yenile
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function renderProjectDeleteButton(userRole) {
        ...
        // Eğer silme butonu daha önce dinamik eklenmediyse oluşturalım
