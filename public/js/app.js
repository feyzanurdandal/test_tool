...
//                                         <span class="step-number text-[10px] font-mono text-zinc-500 w-5 text-center">${String(i + 1).padStart(2, '0')}.</span>
//                                         <input type="text" required placeholder="Adımı yazın" value="${escapeHtml(s.instruction || "")}" class="step-input flex-1 bg-transparent text-xs text-white outline-none">
//                                         <button type="button" class="remove-step-btn text-zinc-600 hover:text-red-400 transition ${steps.length > 1 ? '' : 'opacity-0 pointer-events-none'}"><i data-lucide="trash-2" class="w-3.5 h-3.5"></i></button>
//                                     </div>
//                                 `).join("");
//                             }
