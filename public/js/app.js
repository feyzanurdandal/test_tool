...
//                                 </div>
//                                 <pre class="text-[11px] font-mono whitespace-pre-wrap leading-relaxed select-text">${errorLine.trim()}</pre>
//                             </div>
//                         `;
//                     }
...
//     //     let deleteBtn = document.getElementById("delete-project-btn");
        
//     //     if (!deleteBtn && projectDropdown && projectDropdown.parentElement) {
//     //         deleteBtn = document.createElement("button");
//     //         deleteBtn.id = "delete-project-btn";
//     //         deleteBtn.type = "button";
//     //         deleteBtn.className = "hidden bg-rose-500/10 hover:bg-rose-500/20 text-rose-400 border border-rose-500/20 text-xs px-2.5 py-1.5 rounded-lg transition items-center gap-1 font-medium shrink-0 ml-2";
//     //         deleteBtn.innerHTML = `<i data-lucide="trash-2" class="w-3.5 h-3.5 inline"></i> Projeyi Sil`;
//     //         projectDropdown.parentElement.appendChild(deleteBtn);
            
//     //         deleteBtn.addEventListener("click", () => {
//     //             const selectedProj = projectDropdown.value;
//     //             window.deleteProject(selectedProj);
//     //         });
//     //     }
...
// ─── YENİLENMİŞ MODÜLER RAPOR YÖNETİMİ ───
        ...
        reports.forEach((report) => {
            try {
                ...
                if (report.created_at) {
                    try {
                        formattedDate = new Date(report.created_at).toLocaleString("tr-TR");
                    } catch (e) {
