...
Bilgisayarınıza Node.js veya npm paketleri kurmanıza gerek kalmadan, tüm bağımlılıkları konteyner içinde izole çalıştırmak için. Ancak bu şekilde chromium penceresi açılmaz ve yapay zeka testi arka planda çalıştırır, sadece rapor döner.:
